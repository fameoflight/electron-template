 ...
 * Update chats table
 *
 * Generated on: 2025-11-13T11:05:14.986Z
 *
 * Changes:
...
export class UpdateChats_202511131105149_003 extends BaseMigration {
    metadata: MigrationMetadata = {
        name: 'UpdateChats_202511131105149_003',
        tableName: 'chats',
    ...
    async up(queryRunner: QueryRunner): Promise<void> {
        await this.executeSQL(queryRunner, `
            CREATE TABLE "chats_temp1763031914986" (
  ...
  FOREIGN KEY ("userId") REFERENCES "users" ("id")
            ...
            INSERT INTO "chats_temp1763031914986" ("id", "createdAt", "updatedAt", "deletedAt", "userId", "description", "llmModelId", "status", "streamingStatus", "systemPrompt", "tags", "title") SELECT "id", "createdAt", "updatedAt", "deletedAt", "userId", "description", "llmModelId", "status", "streamingStatus", "systemPrompt", "tags", "title" FROM "chats";
            DROP TABLE "chats";
            ALTER TABLE "chats_temp1763031914986" RENAME TO "chats";
