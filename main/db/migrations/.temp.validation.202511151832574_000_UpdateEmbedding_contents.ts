 ...
 *
 * Generated on: 2025-11-15T18:32:57.449Z
 *
 * Changes:
...
export class UpdateEmbedding_contents_202511151832574_000 extends BaseMigration {
  metadata: MigrationMetadata = {
    name: 'UpdateEmbedding_contents_202511151832574_000',
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    await this.executeSQL(queryRunner, `
            CREATE TABLE "embedding_contents_temp1763231577449" (
