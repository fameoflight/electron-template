 ...
 * Update jobs table
 *
 * Generated on: 2025-11-13T11:05:14.994Z
 *
 * Changes:
...
export class UpdateJobs_202511131105149_007 extends BaseMigration {
    metadata: MigrationMetadata = {
        name: 'UpdateJobs_202511131105149_007',
        tableName: 'jobs',
    ...
    async up(queryRunner: QueryRunner): Promise<void> {
        await this.executeSQL(queryRunner, `
            CREATE TABLE "jobs_temp1763031914994" (
