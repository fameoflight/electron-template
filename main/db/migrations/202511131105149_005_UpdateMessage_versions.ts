 ...
 *
 * Generated on: 2025-11-13T11:05:14.990Z
 *
 * Changes:
...
export class UpdateMessage_versions_202511131105149_005 extends BaseMigration {
    metadata: MigrationMetadata = {
        name: 'UpdateMessage_versions_202511131105149_005',
    ...
    async up(queryRunner: QueryRunner): Promise<void> {
        await this.executeSQL(queryRunner, `
            CREATE TABLE "message_versions_temp1763031914990" (
