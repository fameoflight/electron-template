 ...
 *
 * Generated on: 2025-11-15T18:33:01.587Z
 *
 * Changes:
...
export class UpdateEmbedding_contents_202511151833015_000 extends BaseMigration {
  metadata: MigrationMetadata = {
    name: 'UpdateEmbedding_contents_202511151833015_000',
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    await this.executeSQL(queryRunner, `
            CREATE TABLE "embedding_contents_temp1763231581587" (
