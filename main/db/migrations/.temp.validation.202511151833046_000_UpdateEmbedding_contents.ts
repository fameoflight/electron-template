 ...
 *
 * Generated on: 2025-11-15T18:33:04.601Z
 *
 * Changes:
...
export class UpdateEmbedding_contents_202511151833046_000 extends BaseMigration {
  metadata: MigrationMetadata = {
    name: 'UpdateEmbedding_contents_202511151833046_000',
  ...
  async up(queryRunner: QueryRunner): Promise<void> {
    await this.executeSQL(queryRunner, `
            CREATE TABLE "embedding_contents_temp1763231584601" (
